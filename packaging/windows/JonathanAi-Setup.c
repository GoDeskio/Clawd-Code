...
static LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM w, LPARAM l) {
    ...
    case WM_CREATE: {
        ...
        CreateWindowW(L"STATIC", L"Windows desktop installer  0.4.7", WS_CHILD | WS_VISIBLE,
            24, 44, 400, 20, hwnd, NULL, NULL, NULL);

        g_welcome = CreateWindowW(L"STATIC",
            L"This wizard installs or upgrades Jonathan Ai 0.4.7 in place.\r\n\r\n"
...
int WINAPI wWinMain(HINSTANCE inst, HINSTANCE prev, PWSTR cmd, int show) {
    ...
    RegisterClassW(&wc);
    g_main = CreateWindowW(L"JonathanAiSetup", L"Install Jonathan Ai 0.4.7",
