...
**संस्करण 0.2.0 — Jonathan Ai.** डेस्कटॉप ऐप स्वयं एजेंट है। चैट के लिए एक लोकल मॉडल या एक API कुंजी काफी है। MCP, Cursor और Codex वैकल्पिक हैं। साइडबार में चैट का नाम बदलें। टूल स्कीमा साफ़ किए जाते हैं (`input_schema.type`) ताकि Anthropic 400 न आए।
