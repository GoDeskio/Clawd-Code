...
**संस्करण 0.2.1 — Jonathan Ai.** डेस्कटॉप ऐप स्वयं एजेंट है। चैट के लिए एक लोकल मॉडल या एक API कुंजी काफी है। MCP, Cursor और Codex वैकल्पिक हैं। साइडबार में चैट का नाम बदलें। टूल स्कीमा क्लासिक Anthropic रूप में भेजे जाते हैं (`input_schema.type`)। schema 400 पर वही अनुरोध tools के बिना दोहराया जाता है।
