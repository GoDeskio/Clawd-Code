...
**संस्करण 0.2.6 — Jonathan Ai.** डेस्कटॉप ऐप स्वयं एजेंट है। चैट डिस्क पर रहते हैं; New Chat हमेशा खाली थ्रेड खोलता है। साझा मेमोरी (`~/.clawd/memory`) एक चैट के तथ्य दूसरी में लाती है। MCP, Cursor और Codex वैकल्पिक हैं। साइडबार में चैट का नाम बदलें। टूल स्कीमा क्लासिक Anthropic रूप में भेजे जाते हैं (`input_schema.type`)। schema 400 पर वही अनुरोध tools के बिना दोहराया जाता है।
