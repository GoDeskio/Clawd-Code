...
**الإصدار 0.2.1 — Jonathan Ai.** تطبيق سطح المكتب هو الوكيل نفسه. يكفي نموذج محلي أو مفتاح API واحد للدردشة. MCP وCursor وCodex اختيارية. أعد تسمية المحادثات من الشريط الجانبي. تُرسل مخططات الأدوات بالشكل الكلاسيكي لـ Anthropic (`input_schema.type`). عند 400 schema تُعاد نفس الطلب بدون tools.
