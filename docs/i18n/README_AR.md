...
**الإصدار 0.2.0 — Jonathan Ai.** تطبيق سطح المكتب هو الوكيل نفسه. يكفي نموذج محلي أو مفتاح API واحد للدردشة. MCP وCursor وCodex اختيارية. أعد تسمية المحادثات من الشريط الجانبي. تُنظَّف مخططات الأدوات (`input_schema.type`) لتفادي خطأ Anthropic 400.
